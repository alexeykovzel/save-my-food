      ...
      content: Column(
        children: [
          ...
          SliderSetting(
            ...
            onChanged: (days) => settings.changeNotificationDayGap(days),
            initialValue: settings.getNotifyAfterDays().toDouble(),
            divisions: 10,
          ),
          ...
          SliderSetting(
            ...
            onChanged: (hours) => settings.changeNotificationHour(hours),
            initialValue: settings.getNotifyAtHour().toDouble(),
            divisions: 24,
          ),
        ],
      ),
